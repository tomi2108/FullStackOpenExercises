...
exports.addPatient = exports.updatePatient = exports.getNonSensitivePatients = exports.patients = void 0;
...
const getNonSensitivePatients = () => {
    const nonSensitivePatients = exports.patients.map(({ id, gender, name, dateOfBirth, occupation, entries }) => ({
        id,
        gender,
        name,
        dateOfBirth,
...
const updatePatient = (id, entry) => {
    ...
    const patient = exports.patients.find((p) => p.id === id);
    if (!patient)
        throw new Error("bad request ");
    const newPatient = Object.assign({}, patient);
    if (typeof newPatient.entries === "undefined") {
        newPatient.entries = [];
    }
    newPatient.entries = newPatient.entries.concat(entry);
    exports.patients = exports.patients.map((p) => (p.id === newPatient.id ? newPatient : p));
    return newPatient;
};
...
const addPatient = (entry) => {
    if (!entry)
        throw new Error("bad request");
    const newPatient = Object.assign(Object.assign({}, entry), { id: (0, uuid_1.v1)() });
